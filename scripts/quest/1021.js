 ...
 * @npcname Roger
 * @locationIds 20000
 * @locationNames Maple Road - Snail Garden
 * @description Demonstrates the use of potions
 */
var status = -1;
...
function end(mode, type, selection) {
    if (mode === -1) {
        ...
        if (status === 0) {
            ...
            qm.sendNextPrev("Okay, this is all I can teach you. I know it's sad but it is time to say good bye. Well take care of yourself and Good luck my friend!\r\n\r\n#fUI/UIWindow.img/QuestIcon/4/0#\r\n#v2010000# 3 #t2010000#\r\n#v2010009# 3 #t2010009#\r\n\r\n#fUI/UIWindow.img/QuestIcon/8/0# 10 exp");
        } else if (status === 3) {
